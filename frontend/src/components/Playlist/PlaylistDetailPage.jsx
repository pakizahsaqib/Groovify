...
const PlaylistDetailPage = ({
  ...
  return (
    <div
      className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-4 p-2 text-left text-[#a7a7a7] hover:bg-[#ffffff26] cursor-pointer"
    ...
    >
      ...
      <p className="text-sm hidden sm:block text-center">{formattedDuration}</p>
    </div>
  );
};
