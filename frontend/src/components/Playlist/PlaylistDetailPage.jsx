    ...
    <div className="grid grid-cols-1 justify-between sm:grid-cols-2 md:grid-cols-6 gap-4 p-2 text-left text-[#a7a7a7] hover:bg-[#ffffff26] cursor-pointer">
      <div className="flex text-white col-span-1 md:col-span-2 group">
        ...
        <button
          ...
          className="rounded-full w-9 h-9 pb-1 text-xl font-bold bg-neutral-600 hover:bg-red-600 text-white hover:text-white ml-4 mt-1 md:mt-0 opacity-0 group-hover:opacity-100 transition-opacity"
        >
          -
        </button>
      </div>
      ...
      <a className="text-center hover:text-green-600 ">Play</a>
    </div>
  );
};
